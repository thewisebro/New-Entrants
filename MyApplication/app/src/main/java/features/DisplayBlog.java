...
public class DisplayBlog extends Fragment {
    ...
    public DisplayBlog(String blogUrl){
        this.url=blogUrl;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_display_blog, container, false);
    ...
    public void getData(String str){
        try {
            ...
            JSONArray urls=object.getJSONArray("thumbnails");
            for (int i=0;i<urls.length();i++){
                JSONObject url=urls.getJSONObject(i);
                model.urls.add(url.getString("thumbnail"));
            }
            model.setCategory();
    ...
    private void displayBlog(){
        ...
        pager.setAdapter(new PagerAdapter() {
            @Override
            public int getCount() {
                return model.urls.size();
            }
            @Override
            public Object instantiateItem (ViewGroup container, int position){
                LayoutInflater inflater = getActivity().getLayoutInflater();

                View viewItem = inflater.inflate(R.layout.pager_image_item, container, false);
                ImageView imageView = (ImageView) viewItem.findViewById(R.id.imageView);
                new ImageLoadTask(model.urls.get(position),imageView, (int) getResources().getDimension(R.dimen.blogimg_ht),(int) getResources().getDimension(R.dimen.blogimg_wt))
                        .execute();
