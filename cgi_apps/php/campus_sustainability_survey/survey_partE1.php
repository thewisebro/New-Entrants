...
&nbsp; &nbsp; <a href="logout.php" style="float:right;">Logout</a>
		<h3>Part E. STRATEGIES TO IMPROVE SUSTAINABILTY OF YOUR CAMPUS</h3>
		<br/>
		<div class='question_1'><b>Q.1. To improve further various strategies are listed below; kindly rate it's relevance to make your campus more sustainable.</b></div>
    <br/>
      ...
      foreach($partE_options as $key=>$value){
			...
			echo "</div><br/><br/>";
			$id=$_SESSION['id'];
			$query = "SELECT * FROM questions WHERE id>=155 and id<=164";
      ...
      <div style="width:50%; margin:0 auto;">	
	        <span> <input class="btn-primary" type="button" value="Previous" onClick="window.location.href='survey_partD3.php'">	</span>
			  &nbsp; &nbsp; &nbsp; 
			  <span> <td><input class="btn-primary" type='submit' name='partE_submit' value='Next'></td></tr></span>
		  </div>
		</form>
    </div>
	  </div>
