...
&nbsp;  &nbsp; <a href="logout.php" style="float:right;">Logout</a>
      ...
      foreach($partD_options['ENERGY'] as $key=>$value){
			...
			echo "</div><br/><br/>";
  		$id=$_SESSION['id'];
  		$query = "SELECT * FROM questions WHERE id>=110 and id<=154";
      ...
      while($row = mysql_fetch_assoc($rlt)){
        ...
        if((($count)%3)!=1){
          ...
          echo " <td></td> <td></td> <td></td> <td></td><td></td></tr> ";
				...
				$count_roman++;
				echo "<tr><td width='600px' id='$name' height='40px'>($roman[$count_roman]) $row[question]</td><td></td>";
     ...
     <div style="width:50%; margin:0 auto;">	
	        <span> <input class="btn-primary" type="button" value="Previous" onClick="window.location.href='survey_partD2.php'">	</span>
			  &nbsp; &nbsp; &nbsp; 
