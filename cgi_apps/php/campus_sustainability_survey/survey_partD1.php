...
&nbsp; 
    <a href="logout.php" style="float:right;">Logout</a>
		<h3>Part D. METHODOLOGY TO IMPROVE THE SUSTAINABILITY OF YOUR CAMPUS</h3>
		<br/>
		<div class='question_1'><b>Q.1. Depending on the present activities happening in the various spaces of the campus, Kindly rate the <u>relative importance for regulating these</u> spaces to improve the sustainability of your campus.(Please tick one in each parameter of Energy, Waste and Water).</b>
    </div>
    <br/>
      ...
      foreach($partD_options['ENERGY'] as $key=>$value){
			...
			echo "</div><br/><br/>";
  		$id=$_SESSION['id'];
  		$query = "SELECT * FROM questions WHERE id>=41 and id<=64";
      ...
      <div style="width:50%; margin:0 auto;">	
	        <span> <input class="btn-primary" type="button" value="Previous" onClick="window.location.href='survey_partC2.php'">	</span>
			  &nbsp; &nbsp; &nbsp; 
