...
<?
	...
	echo "<br/><span class='header' id='active_num'>".sizeof($filledInfo)." </span> users <b>awaiting decision</b>.";
...
?>
<br/>
<input id="bt_stylish" type="button" onclick="adminAction('<?echo $user;?>','approve')" value="Approve">&nbsp;&nbsp;|&nbsp;&nbsp;<input id="bt_stylish" type="button" onclick="adminAction('<?echo $user;?>','part_invalid')" value="May be Invalid">&nbsp;&nbsp;|&nbsp;&nbsp;<input id="bt_stylish" type="button" onclick="adminAction('<?echo $user;?>','invalid')" value="Reject">&nbsp;&nbsp;
