...
?>
			...
			<input type="checkbox" name="lec[]" class="chk" id="lec_<?php echo $l++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
...
?>
			...
			<input type="checkbox" name="tut[]" class="chk" id="tut_<? echo $t++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
...
?>
			...
			<input type="checkbox" name="exam[]" class="chk" id="exam_<? echo $e++; ?>"value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
...
?>
			...
			<input type="checkbox" name="soln[]" class="chk" id="soln_<? echo $s++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
...
<?php	
		$i=0;
	echo "<div class='link_container' id='lec_all' style='width:100%; font-size:18px'>Lectures</div>";
	foreach($return_lec as $result)
	{
		if(($result->getPermission()==0 || in_array($result->getCourseId(),$reg_courses) || $facUsername==$id) && $result->getFacultyId()==$id)
		{
...
?>
			<div class="link_container"><a class="file list_selected <? echo $courseId; ?>" target="_blank"  href="<? echo LECDIR; ?>/<? echo $id; ?>/<? echo $result->getFile(); ?>"><? echo $result->getTopic(); ?></a>
			<input type="checkbox" name="lec[]" class="chk_all" id="lec_<?php echo $l++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
	{
		echo "<div class='link_container' id='_all' style='width:100%;text-align:center;'>No Lectures.</div>";
	}
	echo "<br>";

		$i=0;
	echo "<div class='link_container' id='tut_all' style='width:100%; font-size:18px'>Tutorials</div>";
...
?>
			<div class="link_container"><a class="file list_selected <? echo $courseId; ?>" target="_blank"  href="<? echo TUTDIR; ?>/<? echo $id; ?>/<? echo $result->getFile(); ?>"><? echo $result->getTopic(); ?></a>
			<input type="checkbox" name="tut[]" class="chk_all" id="tut_<? echo $t++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
	...
	echo "<br>";
		...
		$i=0;
	echo "<div class='link_container' id='exam_all' style='width:100%; font-size:18px'>Exam Papers</div>";
...
?>
			<div class="link_container"><a class="file list_selected <? echo $courseId; ?>" target="_blank"  href="<? echo EXAMDIR; ?>/<? echo $id; ?>/<? echo $result->getFile(); ?>"><? echo $result->getTopic(); ?></a>
			<input type="checkbox" name="exam[]" class="chk_all" id="exam_<? echo $e++; ?>"value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
	...
	echo "<br>";
		...
		$i=0;
	echo "<div class='link_container' id='soln_all' style='width:100%; font-size:18px'>Solutions</div>";
...
?>
			<div class="link_container"><a class="file list_selected <? echo $courseId; ?>" target="_blank"  href="<? echo SOLNDIR; ?>/<? echo$id; ?>/<? echo $result->getFile(); ?>"><? echo $result->getTopic(); ?></a>
			<input type="checkbox" name="soln[]" class="chk_all" id="soln_<? echo $s++; ?>" value="<? echo $result->getId(); ?>/<? echo $result->getFile(); ?>"></div>
<?php
		}
	}
	if($i==0)
