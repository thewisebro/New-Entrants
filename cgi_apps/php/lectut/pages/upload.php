...
if($size>10485760 || $size == NULL)
{
	echo "Please make sure that a file is selected and it's size is within size limit of 10mb";
	die();
}
else
{
...
*/		$temp=$name;
      ...
      if($return_value)
			{
				header("Location: final_prof.php?temp1=y");	
			}
			else
			{
				header("Location: final_prof.php?temp1=e");	
			}
/*			chmod($dir,0667);
			chmod($dir1,0667);*/
		} 
		...
		{
			header("Location: final_prof.php?temp1=n");	
		}
	}
	else
	{
		header("Location: final_prof.php?temp1=u");	
	}
...
/*			chmod($dir,0667);
	...
	else
	{
		header("Location: final_prof.php?temp1=u");
			...
			break;
		default:
			header("Location: final_prof.php?temp1=x");	
	}
	}
	else //else of the if($facUsername!="") statement
	{
			header("Location: /nucleus/logout?siderror=1");	
	}
}
