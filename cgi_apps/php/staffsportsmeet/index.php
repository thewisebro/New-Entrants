...
<body>
 <div id="page">
	...
	<p onClick=home_page() style="cursor:pointer"><span>20<sup>th</sup> Inter IIT Staff Sports Meet 2012</span></p>
	</div>
	...
	<div id="thumbs" class="navigation">
    	<ul class="thumbs noscript">
     			<?php 
	$query1="Select old_location from staffsportsmeet_photos; ";
