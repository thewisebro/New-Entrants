 ...
 if ($_FILES["ufile$i"]["error"] > 0)
   ...
   if (file_exists("upload/".$_FILES["ufile$i"]['name']))
	...
	echo $_FILES["ufile$i"]['name']." already exists";
   	...
   	{
	$query2="Select id from convo13_photos;";
...
$query="Insert into convo13_photos (old_location,new_location) VALUES ('upload/".$_FILES["ufile$i"]['name']."','upload/image".$rows.".jpg' );";
