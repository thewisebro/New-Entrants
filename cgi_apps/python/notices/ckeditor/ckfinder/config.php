...
*/
$baseUrl = 'http://people.iitr.ernet.in/Notices/userfiles/';
$baseDir = '/home/apps/channel-i-python/notices/userfiles/';
/*
...
Examples:
	...
	// for example if $baseDir is set to  http://example.com/iickfinder/files/
