...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='gate',
            name='week_pref1',
            field=models.CharField(blank=True, max_length=20, null=True, choices=[(b'WEEK1', b'January 30-31, 2016'), (b'WEEK2', b'February 06-07, 2016')]),
        ),
        migrations.AlterField(
            model_name='gate',
            name='week_pref2',
