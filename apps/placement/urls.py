...
urlpatterns += patterns('placement.views_admin',
                        (r'^company/(?P<company_id>\d+)/applications/applied/$', 'finalize'),
                        (r'^company/(?P<company_id>\d+)/applications/applied/(?P<degree>\w+)/$', 'finalize'),
                        (r'^company/(?P<company_id>\d+)/applications/finalized/$', 'unfinalize'),
                        (r'^company/(?P<company_id>\d+)/applications/finalied/(?P<degree>\w+)/$', 'unfinalize'),
                        (r'^company/(?P<company_id>\d+)/applications/shortlisted/$', 'shortlist'),
                        (r'^company/(?P<company_id>\d+)/applications/shortlisted/(?P<task>(xlslist|resumes))/$', 'shortlist'),
                        (r'^company/(?P<company_id>\d+)/applications/remove_shortlist/$', 'remove_shortlist'),
                        (r'^company/(?P<company_id>\d+)/applications/finalized_resumes/$', 'resume_archive'),
                        (r'^company/(?P<company_id>\d+)/applications/finalized_students/$', 'finalized_students'),
                        (r'^company/(?P<company_id>\d+)/applications/selected/$', 'select'),
                        (r'^company/(?P<company_id>\d+)/applications/remove_select/$', 'remove_select'),
                        (r'^company/(?P<company_id>\d+)/applications/accepted/$', 'accept'),
                        (r'^company/(?P<company_id>\d+)/applications/remove_accept/$', 'remove_accept'),
                        (r'^cpt/$', 'cpt'),
