    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cleared_status', models.CharField(max_length=10)),
                ...
                ('backlog_registeredcourse', models.ForeignKey(related_name=b'next_registeredcourse', blank=True, to='nucleus.RegisteredCourse', null=True)),
