    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(related_name=b'suc_trans_buyer', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('request_item', models.OneToOneField(null=True, blank=True, to='buyandsell.RequestedItems')),
                ('sell_item', models.OneToOneField(null=True, blank=True, to='buyandsell.SaleItems')),
                ('seller', models.ForeignKey(related_name=b'suc_trans_seller', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
